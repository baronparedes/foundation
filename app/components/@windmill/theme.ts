// from https://raw.githubusercontent.com/estevanmaito/windmill-react-ui/master/src/themes/default.ts
// since Windmill react only supports Tailwind v2
...
export default {
  ...
  badge: {
    ...
    primary: "text-gmd-700 bg-gmd-100 dark:text-white dark:bg-gmd-600",
  },
  // Backdrop
  backdrop: {
  ...
  textarea: {
    ...
    active:
      "focus:border-gmd-400 border-gray-300 dark:border-gray-600 dark:focus:border-gray-600 dark:bg-gray-700 dark:focus:ring-gray-300 focus:ring focus:ring-gmd-300",
  ...
  select: {
    ...
    active:
      "focus:border-gmd-400 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring focus:ring-gmd-300 dark:focus:ring-gray-300 dark:focus:border-gray-600",
    select: "leading-5",
    disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
    valid:
      "border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200",
  ...
  input: {
    ...
    active:
      "focus:border-gmd-400 border-gray-300 dark:border-gray-600 focus:ring focus:ring-gmd-300 dark:focus:border-gray-600 dark:focus:ring-gray-300 dark:bg-gray-700",
    disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
    valid:
      "border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200",
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200",
    radio:
      "text-gmd-600 form-radio focus:border-gmd-400 focus:outline-none focus:ring focus:ring-gmd-300 focus:ring-offset-0 dark:focus:ring-gray-300",
    checkbox:
      "text-gmd-600 form-checkbox focus:border-gmd-400 focus:outline-none focus:ring focus:ring-gmd-300 focus:ring-offset-0 rounded dark:focus:ring-gray-300",
  },
  // HelperText
  helperText: {
    base: "text-xs",
  ...
  button: {
    ...
    primary: {
      base: "text-white bg-gmd-400 border border-transparent",
      active: "active:bg-gmd-400 hover:bg-gmd-600 focus:ring focus:ring-gmd-300",
      disabled: "opacity-50 cursor-not-allowed",
    },
    outline: {
